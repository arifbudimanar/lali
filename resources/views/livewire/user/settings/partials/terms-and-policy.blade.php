<x-app-card>
    ...
    <x-slot name="description">
        {{ __('Please take a moment to review our Terms of Service and Privacy Policy. By registering, you explicitly agree to comply with these Terms of Service and Privacy Policy.') }}
    </x-slot>
    <x-slot name="actions">
